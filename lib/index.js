...
class Rat {
    constructor(file, options){
        ...
        if(options.queryParams){
            this.queryPrams = options.queryParams;
        }
        ...
        async.each(resources, function(resource, callback){
            ...
            if(resource.hasOwnProperty('methods') && Array.isArray(resource.methods)){
                async.each(resource.methods, function(method, callback){
                    ...
                    request({
                        url: that.baseUri + util.preparers.prepareUri(resource.completeRelativeUri, method.uriParameters) + util.preparers.prepareQueryString(method.queryParameters, that.queryPrams),
